...
let password = '578363';  // 主页密码,建议修改或添加 PASSWORD环境变量
let proxyIP = 'api.jio.com.jio.uk:80';  // proxyIP 格式：ip、域名、ip:port、域名:port等,没填写port，默认使用443
let yourUUID = 'ededa1f6-848c-4040-b3a2-7b94cd253300'; // UUID,建议修改或添加环境便量
